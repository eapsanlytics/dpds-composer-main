...
DAG_CONFIG = Variable.get('DS_APR_VERTEX_MSB_CONFIG', deserialize_json=True)
...
with DAG('ds_vertex_apr_msb_v1',
         description='Workflow to run the APR pipeline definition for MSB markets',
