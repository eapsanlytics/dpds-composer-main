...
with DAG('ds_feature_prep_country_metrics_v1',
         description='Workflow to prepare data to be engineered for feature creation',
         tags=['feature_prep', 'country_metrics', 'vertex'],
         schedule_interval="0 16 9 * *",
    ...
    create_workflow_invocation = DataformCreateWorkflowInvocationOperator(
        ...
        workflow_invocation={
            ...
            "invocation_config": { "included_tags": DAG_CONFIG['DATAFORM_COUNTRY_METRICS_TAGS'] }
        }
    )
